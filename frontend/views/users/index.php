    ...
    <div class="span2">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <?= $form->field($searchModel, 'fullname', ['inputOptions' => ['class' => 'form-control span11', 'placeholder' => '<Nama Lengkap>'],])->textInput()->label(false) ?>
                <?= $form->field($searchModel, 'role', ['inputOptions' => ['class' => 'form-control span11']])->dropDownList(Yii::$app->params['user.type'], ['prompt' => '<Peran>'])->label(false) ?>
    ...
    <div class="span10">
        <div class="widget-box">
            <div class="widget-title">
                ...
                <a href="<?= Url::toRoute(['/users/add']) ?>" title="tambah" class="pull-right"><span class="icon"><i class="icon-plus"></i></span></a>
                <a href="<?= Url::toRoute(['/users']) ?>" title="Segarkan" class="pull-right"><span class="icon"><i class="icon-refresh"></i></span></a>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function($model){
                                return Yii::$app->params['user.type'][$model->role];
                            }
                        ],
                        'created_at:datetime',
                        [
